      ...
      <body className={`${inter.className} h-screen w-screen overflow-hidden`}>
        <Context>
          <Header
            renderBrand={() => (
              <div className="flex">
                <p className="dark:text-white text-gray-950">Real Estate App</p>
              </div>
            )}
            renderMen={() => (
              <nav
          ...
          />
          <SideBar />
          <div className="h-full w-full transition-[padding] duration-500 pt-14 pb-20 md:pl-20 md:pb-0  bg-gray-50">
            {children}
          </div>
        </Context>
      </body>
